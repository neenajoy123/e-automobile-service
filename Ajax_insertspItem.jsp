...
<%
    ...
    String ins="insert into tbl_sparepartspurchase(sph_id,sp_id,sppurchase_rate,sppurchase_utotal,sppurchase_quantity) values('"+session.getAttribute("sph")+"','"+spareparts+"','"+session.getAttribute("rate")+"','"+session.getAttribute("utotal")+"','"+qun+"')";
    ...
    if(b)
    {
        ...
        {
            String in="insert into tbl_branchspareparts(branch_id,sp_id,bsp_stock) values('"+session.getAttribute("Branch") +"','"+model+"','"+qun1+"')";

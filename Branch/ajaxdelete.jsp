...
<%
    //.
    String sel="select model_id,vpurchase_quantity from tbl_vehiclepurchase where vpurchase_id="+request.getParameter("id");
    ResultSet rs=obj.selectData(sel);
    System.out.println(sel);
    if(rs.next())
    {
        int qun=0;
        int qunt=Integer.parseInt(rs.getString("vpurchase_quantity"));
        int qun1=0;
      ...
      String delete="delete from tbl_vehiclepurchase where vpurchase_id="+request.getParameter("id");

...
<%
    String sel="select sp_id,sppurchase_quantity from tbl_sparepartspurchase where sppurchase_id="+request.getParameter("id");
    ResultSet rs=obj.selectData(sel);
    System.out.println(sel);
    if(rs.next())
    {
        int qun=0;
        int qunt=Integer.parseInt(rs.getString("sppurchase_quantity"));
        int qun1=0;
 ...
 String delete="delete from tbl_sparepartspurchase where sppurchase_id="+request.getParameter("id");

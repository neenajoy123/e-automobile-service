    ...
    <body>
        ...
        <%
            ...
            if(request.getParameter("btnsubmit")!=null)
            {
                ...
                {
                   String sel="select l.login_id from tbl_login l inner join tbl_branch b inner join tbl_place p on l.login_id=b.login_id and b.place_id=p.place_id where l.login_password='"+current+"' and b.branch_id='"+session.getAttribute("Branch")+"'";

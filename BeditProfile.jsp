...
<html>
    ...
    <body>
        ...
        String Uname="";
        String logid="";
        String sel="select * from tbl_branch b inner join tbl_login l on b.login_id=l.login_id  where branch_id='"+session.getAttribute("Branch")+"'";
            ...
            
        {
            ...
            if(bb==true)
            {
        String up="update tbl_branch set branch_name='"+Branchname+"',branch_address='"+Address+"',branch_contact='"+Conno+"',branch_email='"+Email+"' where branch_id='"+session.getAttribute("Branch")+"'";

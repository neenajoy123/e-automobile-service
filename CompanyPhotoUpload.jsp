...
if(isMultipart)
{
   ...
   Iterator itr=items_list.iterator();
    ...
    while(itr.hasNext())
    {
       ...
       else
       {
           ...
           String ext=file_name.substring(file_name.lastIndexOf("."));
            ...
            String file_path=proj_path.getParentFile().getParentFile().getPath()+"\\web\\Company\\Logo\\";
            Random r=new Random();
    ...
    String ins="insert into tbl_login(login_username,login_password,login_type)values('"+value[5]+"','"+value[6]+"','Company')";
    ...
    out.println(ins);
       ...
       String str1="insert into tbl_company(comp_name,comp_address,comp_con_no,comp_email,comp_start_date,comp_logo,login_id)values('"+value[0]+"','"+value[1]+"','"+value[2]+"','"+value[3]+"','"+value[4]+"','"+fn+"','"+login+"')";

...
<html>
    ...
    <%
        ...
        {
            disname=request.getParameter("txtname");
            if(request.getParameter("hid")!="")
            {
                String up="update tbl_district set dis_name='"+disname+"' where dis_id='"+request.getParameter("hid")+"'";
           ...
           String insQry="insert into tbl_district(dis_name)values('"+disname+"')";
